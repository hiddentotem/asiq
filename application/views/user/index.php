                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group text-right ">
                            <button type="button" class="btn btn-sm btn-secondary" id="reset-form"><i class="fas fa-fw fa-times"></i> Cancel</button>
            ...
            <div class="card shadow profile-card hide">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group text-right">
                            <button type="button" class="btn btn-sm btn-secondary"><i class="fas fa-fw fa-times"></i> Cancel</button>
                            <button type="button" class="btn btn-sm btn-primary"><i class="fas fa-fw fa-edit"></i> Submit</button>
                        </div>
                    </form>
                </div>
            </div>
